...
vlog "./generate_cnn_benchmark_predictions.sv"
...
vsim -voptargs="+acc" -t 1ps -lib work generate_cnn_benchmark_predictions

# Source the wave do file
#     This should be the file that sets up the signal window for
#     the module you are testing.
do generate_cnn_benchmark_predictions_wave.do
