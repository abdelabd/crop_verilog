...
add wave -noupdate /crop_plus_gaussian_testbench/dut/crop_plus_fifo_inst/crop_filter_inst/X1
...
WaveRestoreCursors {{Cursor 1} {647425000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1168182750 ps}
